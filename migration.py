...
def upgrade():
    ...
    try:
        op.add_column('container_challenge', sa.Column('ssh_username', sa.String(length=100), server_default=""))
    except Exception:
        pass
    
    try:
        op.add_column('container_challenge', sa.Column('ssh_password', sa.String(length=100), server_default=""))
    except Exception:
        pass
