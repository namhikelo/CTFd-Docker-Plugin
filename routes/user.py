...
def request_container():
    ...
    try:
        ...
        logger.error(f"Error requesting container: {e}", exc_info=True)
        return jsonify({'error': 'An internal error occurred while requesting the container.'}), 500
...
def get_container_info(challenge_id):
    ...
    try:
        ...
        logger.error(f"Error fetching container info: {e}", exc_info=True)
        return jsonify({'error': 'An internal error occurred while fetching container info.'}), 500
...
def renew_container():
    ...
    try:
        ...
        logger.error(f"Error renewing container: {e}", exc_info=True)
        return jsonify({'error': 'An internal error occurred while renewing the container.'}), 500
