                    ...
                    if use_subdomain:
                        ...
                        if challenge.container_connection_type == 'ssh':
                            if challenge.ssh_username:
                                connection_info_dict['username'] = challenge.ssh_username
                            if challenge.ssh_password:
                                # SECURITY: Decrypt SSH password from encrypted storage
                                connection_info_dict['password'] = ContainerConfig.decrypt_value(challenge.ssh_password)
                        instance.connection_info = connection_info_dict
